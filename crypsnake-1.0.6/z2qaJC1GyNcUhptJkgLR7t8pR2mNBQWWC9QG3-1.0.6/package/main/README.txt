CrypSnake - Game part of CrypThor ArcAde Saga

#Eat the Bitcoin to grow the snake

#Each time the snake eats, the snake speed increases

#The snake can exit the game area on one side and re-enter it on the opposite side
